...
router.get('/chat/get-seller-last-messages', authMiddleware, chatController.get_last_seller_message)
router.get('/chat/get-seller-unseen-count', authMiddleware, chatController.get_seller_unseen_count)
